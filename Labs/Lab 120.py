...
#                     'Y']})
aaCountInsulin = {}
acidList = ['A', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'V', 'W', 'Y']
for acid in aaWeights:
    aaCountInsulin[acid] = insulin.upper().count(acid)
...
for acid in aaCountInsulin:
    molecularWeightInsulin += aaCountInsulin[acid] * aaWeights[acid]
